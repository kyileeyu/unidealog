...
- [ ] **Test**: `formatTimeAgo` 함수 테스트 작성
  ...
  - [ ] N주 전
  - [ ] N개월 전
- [ ] **Code**: `formatTimeAgo` 함수 구현
- [ ] **Test**: 스레드 마크다운 파일 읽기 함수 테스트
- [ ] **Code**: 스레드 파일 읽기 로직 구현
- [ ] `content/threads/` 폴더 생성
- [ ] 샘플 스레드 마크다운 파일 작성
  - [ ] `content/threads/001-law-of-attraction.md`
  - [ ] `content/threads/002-life-game.md`
